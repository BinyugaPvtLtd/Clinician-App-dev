...
class ClinitianInfoScreen extends StatefulWidget {
  ...
  @override
  State<ClinitianInfoScreen> createState() => _ClinitianInfoScreenState();
}

class _ClinitianInfoScreenState extends State<ClinitianInfoScreen> with SingleTickerProviderStateMixin {
  final StreamController<EmpDetailsDataClass> groupInfoController =
  StreamController<EmpDetailsDataClass>();
  ...
  Future<void> _loadPatientsGroupInfo() async {
    try {
      final data = await chatController.getEmpDetailCommunication(widget.empId);
  ...
  Future<void> _downloadAndOpenPdf(String url) async {
    try {
      ...
      final fileData = await chatController.getEmployeeDocumentByFileName(
        fileUrl: url,
        apiPath: ChatRepository.getChatImagesBasePath(isGroup: false),
      );
          ...
          children: [
            ...
            Expanded(
              child: Padding(
                ...
                child: StreamBuilder<EmpDetailsDataClass>(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ListView.separated(
                            ...
                            itemCount: groupInfo.media.length,
                            separatorBuilder: (_, __) => const SizedBox(width: 6),
                            itemBuilder: (context, index) {
                              final url = groupInfo.media[index];
