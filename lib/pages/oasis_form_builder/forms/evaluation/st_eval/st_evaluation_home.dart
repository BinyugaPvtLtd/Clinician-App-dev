...
import '../../oasis_st_start_of_care/static_screens/static_functional_assessment.dart';


class STEvaluationHome extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const STEvaluationHome({super.key, this.form, this.subForm, this.patient});

  @override
  State<STEvaluationHome> createState() => _STEvaluationHomeState();
}

class _STEvaluationHomeState extends State<STEvaluationHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 33, subFormId: 4),
    ), SideDrawerItem(
      itemTitle: 'Clinical Record Items',
      widget: OasisFormBuilder(formId: 33, subFormId: 3),
    ),
    SideDrawerItem(
      itemTitle: 'Subjective',
      widget: OasisFormBuilder(formId: 33, subFormId: 41),
    ),
    SideDrawerItem(
      itemTitle: 'Pain',
      widget: OasisFormBuilder(formId: 33, subFormId: 9),
    ),
    SideDrawerItem(
      itemTitle: 'Vital Signs',
      widget: OasisFormBuilder(formId: 33, subFormId: 8),
    ),
    SideDrawerItem(
      itemTitle: 'Integumentary Status',
      widget: OasisFormBuilder(formId: 33, subFormId: 19),
    ), SideDrawerItem(
      itemTitle: 'Cognitive/Neurological',
      widget: OasisFormBuilder(formId: 33, subFormId: 12),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Status',
      widget: StaticFunctionalAssessment(formId: 33, subFormId: 22),
    ),
    SideDrawerItem(
      itemTitle: 'Objective',
      widget: OasisFormBuilder(formId: 33, subFormId: 45),
    ),
    SideDrawerItem(
      itemTitle: 'Assessment',
      widget: OasisFormBuilder(formId: 33, subFormId: 30),
    ),
    SideDrawerItem(
      itemTitle: 'Plan Of Care',
      widget: OasisFormBuilder(formId: 33, subFormId: 32),
    ),
    SideDrawerItem(
      itemTitle: 'Care Planning/Coordination',
      widget: OasisFormBuilder(formId: 33, subFormId: 33),
    ),
    SideDrawerItem(
      itemTitle: 'Summary For Physician',
      widget: OasisFormBuilder(formId: 33, subFormId: 51),
    ),
  ];
