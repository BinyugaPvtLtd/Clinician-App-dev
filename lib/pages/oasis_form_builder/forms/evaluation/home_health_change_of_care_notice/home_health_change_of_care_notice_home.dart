...
class HomeHealthChangeOfCareNoticeHome extends StatefulWidget {
  const HomeHealthChangeOfCareNoticeHome({super.key});

  @override
  State<HomeHealthChangeOfCareNoticeHome> createState() =>
      _HomeHealthChangeOfCareNoticeHomeState();
}

class _HomeHealthChangeOfCareNoticeHomeState
    extends State<HomeHealthChangeOfCareNoticeHome> {
  bool isLoading = true;
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      itemTitle: 'Home Health Change Of Care Notice (HHCCN)',
      widget: OasisFormBuilder(formId: 60, subFormId: 59),
    ),
  ];
}
