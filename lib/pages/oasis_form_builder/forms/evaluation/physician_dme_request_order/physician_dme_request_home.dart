...
class PhysicianDMERequestHome extends StatefulWidget {
  const PhysicianDMERequestHome({super.key});

  @override
  State<PhysicianDMERequestHome> createState() =>
      _PhysicianDMERequestHomeState();
}

class _PhysicianDMERequestHomeState
    extends State<PhysicianDMERequestHome> {
  bool isLoading = true;
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      itemTitle: 'Physician DME Request',
      widget: OasisFormBuilder(formId: 70, subFormId: 60),
    ),
  ];
}
