...
class HomeHealthAideCarePlan extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const HomeHealthAideCarePlan({super.key, this.form, this.subForm, this.patient});

  @override
  State<HomeHealthAideCarePlan> createState() => _HomeHealthAideCarePlanState();
}

class _HomeHealthAideCarePlanState extends State<HomeHealthAideCarePlan> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 23, subFormId: 46),
    ),
    SideDrawerItem(
      itemTitle: 'Report to Supervising Clinician',
      widget: OasisFormBuilder(formId: 23, subFormId: 48),
    ),
    SideDrawerItem(
      itemTitle: 'Safety Precautions',
      widget: OasisFormBuilder(formId: 23, subFormId: 49),
    ),
    SideDrawerItem(
      itemTitle: 'Tasks',
      widget: OasisFormBuilder(formId: 23, subFormId: 50),
    ),
  ];
