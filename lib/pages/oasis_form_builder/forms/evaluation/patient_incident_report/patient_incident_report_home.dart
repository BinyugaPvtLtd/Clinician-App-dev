...
class PatientIncidentReportHome extends StatefulWidget {
  const PatientIncidentReportHome({super.key});

  @override
  State<PatientIncidentReportHome> createState() =>
      _PatientIncidentReportHomeState();
}

class _PatientIncidentReportHomeState
    extends State<PatientIncidentReportHome> {
  bool isLoading = true;
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      itemTitle: 'Patient-Related Incident',
      widget: OasisFormBuilder(formId: 68, subFormId: 64),
    ),
    SideDrawerItem(
      itemTitle: 'Notifications',
      widget: OasisFormBuilder(formId: 68, subFormId: 65),
    ),
    SideDrawerItem(
      itemTitle: 'Administrative Follow up',
      widget: OasisFormBuilder(formId: 68, subFormId: 66),
    ),
  ];
}
