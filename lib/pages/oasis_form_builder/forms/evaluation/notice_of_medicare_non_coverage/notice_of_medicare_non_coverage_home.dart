...
class NoticeOfMedicareNonCoverageHome extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const NoticeOfMedicareNonCoverageHome({super.key, this.form, this.subForm, this.patient});

  @override
  State<NoticeOfMedicareNonCoverageHome> createState() => _NoticeOfMedicareNonCoverageHomeState();
}

class _NoticeOfMedicareNonCoverageHomeState extends State<NoticeOfMedicareNonCoverageHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      itemTitle: 'Page 1',
      widget: OasisFormBuilder(formId: 59, subFormId: 63),
    ),SideDrawerItem(
      itemTitle: 'Page 2',
      widget: OasisFormBuilder(formId: 59, subFormId: 0),
    ),
  ];
