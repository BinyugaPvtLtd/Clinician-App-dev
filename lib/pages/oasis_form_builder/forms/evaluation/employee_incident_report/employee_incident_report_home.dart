...
class EmployeeIncidentReportHome extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const EmployeeIncidentReportHome({super.key, this.form, this.subForm, this.patient});

  @override
  State<EmployeeIncidentReportHome> createState() => _EmployeeIncidentReportHomeState();
}

class _EmployeeIncidentReportHomeState extends State<EmployeeIncidentReportHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      itemTitle: 'Employee-Related Incident',
      widget: OasisFormBuilder(formId: 69, subFormId: 64),
    ),
    SideDrawerItem(
      itemTitle: 'Notifications',
      widget: OasisFormBuilder(formId: 69, subFormId: 65),
    ),
    SideDrawerItem(
      itemTitle: 'Administrative Follow up',
      widget: OasisFormBuilder(formId: 69, subFormId: 66),
    ),
  ];
