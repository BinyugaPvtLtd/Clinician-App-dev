...
class PhysicalTherapyEvaluationHome extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const PhysicalTherapyEvaluationHome({super.key, this.form, this.subForm, this.patient});

  @override
  State<PhysicalTherapyEvaluationHome> createState() => _PhysicalTherapyEvaluationHomeState();
}

class _PhysicalTherapyEvaluationHomeState extends State<PhysicalTherapyEvaluationHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    ...
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 31, subFormId: 3),
    ),
    SideDrawerItem(
      itemTitle: 'Patient History/Immunization',
      widget: OasisFormBuilder(formId: 31, subFormId: 4),
    ),
    SideDrawerItem(
      itemTitle: 'Subjective',
      widget: OasisFormBuilder(formId: 31, subFormId: 41),
    ),
    SideDrawerItem(
      itemTitle: 'Vital Signs/Pain/Height & Weight',
      widget: OasisFormBuilder(formId: 31, subFormId: 8),
    ),
    SideDrawerItem(
      itemTitle: 'Pain',
      widget: OasisFormBuilder(formId: 31, subFormId: 9),
    ),
    SideDrawerItem(
      itemTitle: 'Cognitive/Neurological Status',
      widget: OasisFormBuilder(formId: 31, subFormId: 12),
    ),

    SideDrawerItem(
      itemTitle: 'Integumentary/Wound Care',
      widget: OasisFormBuilder(formId: 31, subFormId: 19),
    ),
    SideDrawerItem(
      itemTitle: 'Prior Level Of Function',
      widget: OasisFormBuilder(formId: 31, subFormId: 44),
    ),
    SideDrawerItem(
      itemTitle: 'Musculoskeletal',
      widget: OasisFormBuilder(formId: 31, subFormId: 21),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Assessment',
      widget: OasisFormBuilder(formId: 31, subFormId: 42),
    ),
    SideDrawerItem(
      itemTitle: 'Tests/Scales',
      widget: OasisFormBuilder(formId: 31, subFormId: 43),
    ),
    SideDrawerItem(
      itemTitle: 'Objective',
      widget: OasisFormBuilder(formId: 31, subFormId: 45),
    ),
    SideDrawerItem(
      itemTitle: 'Assessment',
      widget: OasisFormBuilder(formId: 31, subFormId: 30),
    ),
    SideDrawerItem(
      itemTitle: 'Plan Of Care',
      widget: OasisFormBuilder(formId: 31, subFormId: 32),
    ),
    SideDrawerItem(
      itemTitle: 'Plan/Care Coordination',
      widget: OasisFormBuilder(formId: 31, subFormId: 33),
    ), SideDrawerItem(
      itemTitle: 'Summary for Physician',
      widget: OasisFormBuilder(formId: 31, subFormId: 51),
    ),
    SideDrawerItem(
      itemTitle: 'ADLs',
      widget: OasisFormBuilder(formId: 31, subFormId: 68),
    ),
