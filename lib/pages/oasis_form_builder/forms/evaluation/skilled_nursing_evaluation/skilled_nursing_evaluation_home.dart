...
class SkilledNursingEvaluationHome extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const SkilledNursingEvaluationHome({super.key, this.form, this.subForm, this.patient});

  @override
  State<SkilledNursingEvaluationHome> createState() => _SkilledNursingEvaluationHomeState();
}

class _SkilledNursingEvaluationHomeState extends State<SkilledNursingEvaluationHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 30, subFormId: 4),
    ),
    SideDrawerItem(
      itemTitle: 'Clinical Record Items',
      widget: OasisFormBuilder(formId: 30, subFormId: 3),
    ),
    SideDrawerItem(
      itemTitle: 'Vital Signs, Height & Weight',
      widget: OasisFormBuilder(formId: 30, subFormId: 8),
    ),
    SideDrawerItem(
      itemTitle: 'Pain',
      widget: OasisFormBuilder(formId: 30, subFormId: 9),
    ), SideDrawerItem(
      itemTitle: 'Hearing/Speech/Vision',
      widget: OasisFormBuilder(formId: 30, subFormId: 10),
    ),
    SideDrawerItem(
      itemTitle: 'Neurological/Cognitive',
      widget: OasisFormBuilder(formId: 30, subFormId: 12),
    ), SideDrawerItem(
      itemTitle: 'Behaviour/Risk Factors',
      widget: OasisFormBuilder(formId: 30, subFormId: 14),
    ),
    SideDrawerItem(
      itemTitle: 'Respiratory',
      widget: OasisFormBuilder(formId: 30, subFormId: 15),
    ),
    SideDrawerItem(
      itemTitle: 'Cardiovascular',
      widget: OasisFormBuilder(formId: 30, subFormId: 16),
    ),
    SideDrawerItem(
      itemTitle: 'Genitourinary',
      widget: OasisFormBuilder(formId: 30, subFormId: 17),
    ),
    SideDrawerItem(
      itemTitle: 'Gastrointestinal/Nutrition/Endocrine',
      widget: OasisFormBuilder(formId: 30, subFormId: 18),
    ), SideDrawerItem(
      itemTitle: 'Integumentary/Wound Care',
      widget: WoundScreen(formId: 30, subFormId: 19),
    ), SideDrawerItem(
      itemTitle: 'Musculoskeletal',
      widget: OasisFormBuilder(formId: 30, subFormId: 21),
    ), SideDrawerItem(
      itemTitle: 'Functional Status/Fall Risk',
      widget: OasisFormBuilder(formId: 30, subFormId: 24),
    ), SideDrawerItem(
      itemTitle: 'Medications',
      widget: OasisFormBuilder(formId: 30, subFormId: 25),
    ), SideDrawerItem(
      itemTitle: 'Infusion/Lab Draw',
      widget: OasisFormBuilder(formId: 30, subFormId: 26),
    ), SideDrawerItem(
      itemTitle: 'Interventions/Education Provided',
      widget: OasisFormBuilder(formId: 30, subFormId: 29),
    ), SideDrawerItem(
      itemTitle: 'Assessment Summary',
      widget: OasisFormBuilder(formId: 30, subFormId: 30),
    ), SideDrawerItem(
      itemTitle: 'Supplies',
      widget: OasisFormBuilder(formId: 30, subFormId: 31),
    ), SideDrawerItem(
      itemTitle: 'Plan Of Care',
      widget: OasisFormBuilder(formId: 30, subFormId: 32),
    ), SideDrawerItem(
      itemTitle: 'Care Planning/coordination',
      widget: OasisFormBuilder(formId: 30, subFormId: 33),
    ), SideDrawerItem(
      itemTitle: 'Summary For Physician',
      widget: OasisFormBuilder(formId: 30, subFormId: 51),
    ),
    SideDrawerItem(
      itemTitle: 'Diagnosis Codes',
      widget: OasisFormBuilder(formId: 30, subFormId: 34),
    ),
  ];
