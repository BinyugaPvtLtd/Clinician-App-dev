...
class SpeechTherapyReassessmentHome extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const SpeechTherapyReassessmentHome({super.key, this.form, this.subForm, this.patient});

  @override
  State<SpeechTherapyReassessmentHome> createState() => _SpeechTherapyReassessmentHomeState();
}

class _SpeechTherapyReassessmentHomeState extends State<SpeechTherapyReassessmentHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 40, subFormId: 4),
    ),
    SideDrawerItem(
      itemTitle: 'Clinical Record Items',
      widget: OasisFormBuilder(formId: 40, subFormId: 3),
    ),
    SideDrawerItem(
      itemTitle: 'Subjective',
      widget: OasisFormBuilder(formId: 40, subFormId: 41),
    ),
    SideDrawerItem(
      itemTitle: 'Vital Signs',
      widget: OasisFormBuilder(formId: 40, subFormId: 8),
    ),
    SideDrawerItem(
      itemTitle: 'Pain',
      widget: OasisFormBuilder(formId: 40, subFormId: 9),
    ),SideDrawerItem(
      itemTitle: 'Interventions/Education Provided',
      widget: OasisFormBuilder(formId: 40, subFormId: 29),
    ),SideDrawerItem(
      itemTitle: 'Assessment',
      widget: OasisFormBuilder(formId: 40, subFormId: 30),
    ),
    SideDrawerItem(
      itemTitle: 'Supervision',
      widget: OasisFormBuilder(formId: 40, subFormId: 38),
    ),
    SideDrawerItem(
      itemTitle: 'Care Planning/coordination',
      widget: OasisFormBuilder(formId: 40, subFormId: 33),
    ),SideDrawerItem(
      itemTitle: 'Summary For Physician',
      widget: OasisFormBuilder(formId: 40, subFormId: 51),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Status',
      widget: StaticFunctionalAssessment(formId: 40, subFormId: 42),
    ),
  ];
