...
class OTEvaluationHome extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const OTEvaluationHome({super.key, this.form, this.subForm, this.patient});

  @override
  State<OTEvaluationHome> createState() => _OTEvaluationHomeState();
}

class _OTEvaluationHomeState extends State<OTEvaluationHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 32, subFormId: 4),
    ), SideDrawerItem(
      itemTitle: 'Clinical Record Items',
      widget: OasisFormBuilder(formId: 32, subFormId: 3),
    ),
    SideDrawerItem(
      itemTitle: 'Subjective',
      widget: OasisFormBuilder(formId: 32, subFormId: 41),
    ),
    SideDrawerItem(
      itemTitle: 'Pain',
      widget: OasisFormBuilder(formId: 32, subFormId: 9),
    ),
    SideDrawerItem(
      itemTitle: 'Vital Signs',
      widget: OasisFormBuilder(formId: 32, subFormId: 8),
    ),
    SideDrawerItem(
      itemTitle: 'Integumentary Status',
      widget: OasisFormBuilder(formId: 32, subFormId: 19),
    ),
    SideDrawerItem(
      itemTitle: 'Objective',
      widget: OasisFormBuilder(formId: 32, subFormId: 45),
    ),
    SideDrawerItem(
      itemTitle: 'Assessment',
      widget: OasisFormBuilder(formId: 32, subFormId: 30),
    ),
    SideDrawerItem(
      itemTitle: 'Plan Of Care',
      widget: OasisFormBuilder(formId: 32, subFormId: 32),
    ),
    SideDrawerItem(
      itemTitle: 'Care Planning/Coordination',
      widget: OasisFormBuilder(formId: 32, subFormId: 33),
    ),
    SideDrawerItem(
      itemTitle: 'Summary For Physician',
      widget: OasisFormBuilder(formId: 32, subFormId: 51),
    ),
    SideDrawerItem(
      itemTitle: 'Tests/Scales',
      widget: OasisFormBuilder(formId: 32, subFormId: 43),
    ),
    SideDrawerItem(
      itemTitle: 'Musculoskeletal',
      widget: OasisFormBuilder(formId: 32, subFormId: 21),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Assessment',
      widget: OasisFormBuilder(formId: 32, subFormId: 42),
    ),
    SideDrawerItem(
      itemTitle: 'Neurological/Cognitive Patterns',
      widget: OasisFormBuilder(formId: 32, subFormId: 12),
    ),
    SideDrawerItem(
      itemTitle: 'Prior Level Of Function',
      widget: OasisFormBuilder(formId: 32, subFormId: 44),
    ),
    SideDrawerItem(
      itemTitle: 'ADLs',
      widget: OasisFormBuilder(formId: 32, subFormId: 68),
    ),
  ];
