...
class CareCoordinationNoteHome extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const CareCoordinationNoteHome({super.key, this.form, this.subForm, this.patient});

  @override
  State<CareCoordinationNoteHome> createState() => _CareCoordinationNoteHomeState();
}

class _CareCoordinationNoteHomeState extends State<CareCoordinationNoteHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      itemTitle: 'Care Coordination Note',
      widget: OasisFormBuilder(formId: 35, subFormId: 33),
    ),
  ];
