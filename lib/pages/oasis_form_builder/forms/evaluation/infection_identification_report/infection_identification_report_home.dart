...
class InfectionIdentificationReportHome extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const InfectionIdentificationReportHome({super.key, this.form, this.subForm, this.patient});

  @override
  State<InfectionIdentificationReportHome> createState() => _InfectionIdentificationReportHomeState();
}

class _InfectionIdentificationReportHomeState extends State<InfectionIdentificationReportHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      itemTitle: 'Infection Identification Number',
      widget: OasisFormBuilder(formId: 66, subFormId: 70),
    ),
  ];
