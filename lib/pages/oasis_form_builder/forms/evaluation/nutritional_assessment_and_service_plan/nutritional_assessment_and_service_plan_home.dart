...
class NutritionalAssessmentAndServicePlan extends StatefulWidget {
  const NutritionalAssessmentAndServicePlan({super.key});

  @override
  State<NutritionalAssessmentAndServicePlan> createState() =>
      _NutritionalAssessmentAndServicePlanState();
}

class _NutritionalAssessmentAndServicePlanState
    extends State<NutritionalAssessmentAndServicePlan> {
  bool isLoading = true;
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      itemTitle: 'Patient Information & Signature',
      widget: OasisFormBuilder(formId: 75, subFormId: 4),
    ),SideDrawerItem(
      itemTitle: 'Nutritional Assessment',
      widget: OasisFormBuilder(formId: 75, subFormId: 57),
    ),
  ];
}
