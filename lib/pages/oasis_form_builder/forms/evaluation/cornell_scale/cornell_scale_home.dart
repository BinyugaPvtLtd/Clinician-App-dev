...
class CornellScaleHome extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const CornellScaleHome({super.key, this.form, this.subForm, this.patient});

  @override
  State<CornellScaleHome> createState() => _CornellScaleHomeState();
}

class _CornellScaleHomeState extends State<CornellScaleHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      itemTitle: 'Administration & Scoring',
      widget: OasisFormBuilder(formId: 63, subFormId: 71),
    ),
    SideDrawerItem(
      itemTitle: 'Informant Interview',
      widget: OasisFormBuilder(formId: 63, subFormId: 72),
    ),
    SideDrawerItem(
      itemTitle: 'Patient Interview',
      widget: OasisFormBuilder(formId: 63, subFormId: 73),
    ),
    SideDrawerItem(
      itemTitle: 'Raters Clinical Impression',
      widget: OasisFormBuilder(formId: 63, subFormId: 74),
    ),
  ];
