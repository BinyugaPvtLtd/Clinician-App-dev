...
class PhysicianOrderHome extends StatefulWidget {
  const PhysicianOrderHome({super.key});

  @override
  State<PhysicianOrderHome> createState() => _PhysicianOrderHomeState();
}

class _PhysicianOrderHomeState extends State<PhysicianOrderHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      itemTitle: 'Physician Order',
      widget: OasisFormBuilder(formId: 73, subFormId: 75),
    ),
  ];
}
