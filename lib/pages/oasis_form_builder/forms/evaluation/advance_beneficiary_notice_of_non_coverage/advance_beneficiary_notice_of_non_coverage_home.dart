...
class AdvanceBeneficiaryNoticeOfNoCoverageHome extends StatefulWidget {
  const AdvanceBeneficiaryNoticeOfNoCoverageHome({super.key});

  @override
  State<AdvanceBeneficiaryNoticeOfNoCoverageHome> createState() =>
      _AdvanceBeneficiaryNoticeOfNoCoverageHomeState();
}

class _AdvanceBeneficiaryNoticeOfNoCoverageHomeState
    extends State<AdvanceBeneficiaryNoticeOfNoCoverageHome> {
  bool isLoading = true;
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      itemTitle: "Advance Beneficiary Notice Of Noncoverage (ABN)",
      widget: OasisFormBuilder(formId: 62, subFormId: 67),
    ),
  ];
}
