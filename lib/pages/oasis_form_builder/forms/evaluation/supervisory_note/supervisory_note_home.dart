...
class SupervisoryNoteHome extends StatefulWidget {
  const SupervisoryNoteHome({super.key});

  @override
  State<SupervisoryNoteHome> createState() => _SupervisoryNoteHomeState();
}

class _SupervisoryNoteHomeState extends State<SupervisoryNoteHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 76, subFormId: 38),
    ),
  ];
}
