...
class PhysicalTherapyReassessmentHome extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const PhysicalTherapyReassessmentHome({super.key, this.form, this.subForm, this.patient});

  @override
  State<PhysicalTherapyReassessmentHome> createState() => _PhysicalTherapyReassessmentHomeState();
}

class _PhysicalTherapyReassessmentHomeState extends State<PhysicalTherapyReassessmentHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 41, subFormId: 4),
    ),
    SideDrawerItem(
      itemTitle: 'Clinical Record Items',
      widget: OasisFormBuilder(formId: 41, subFormId: 3),
    ),
    SideDrawerItem(
      itemTitle: 'Subjective',
      widget: OasisFormBuilder(formId: 41, subFormId: 41),
    ),
    SideDrawerItem(
      itemTitle: 'Vital Signs',
      widget: OasisFormBuilder(formId: 41, subFormId: 8),
    ),
    SideDrawerItem(
      itemTitle: 'Pain',
      widget: OasisFormBuilder(formId: 41, subFormId: 9),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Assessment',
      widget: OasisFormBuilder(formId: 41, subFormId: 42),
    ),
    SideDrawerItem(
      itemTitle: 'Musculoskeletal',
      widget: OasisFormBuilder(formId: 41, subFormId: 21),
    ),
    SideDrawerItem(
      itemTitle: 'Tests/Scales',
      widget: OasisFormBuilder(formId: 41, subFormId: 43),
    ),
    SideDrawerItem(
      itemTitle: 'Assessment',
      widget: OasisFormBuilder(formId: 41, subFormId: 30),
    ),
    SideDrawerItem(
      itemTitle: 'Objective',
      widget: OasisFormBuilder(formId: 41, subFormId: 45),
    ),
    SideDrawerItem(
      itemTitle: 'Care Planning/coordination',
      widget: OasisFormBuilder(formId: 41, subFormId: 33),
    ),
    SideDrawerItem(
      itemTitle: 'Summary For Physician',
      widget: OasisFormBuilder(formId: 41, subFormId: 51),
    ),
    SideDrawerItem(
      itemTitle: 'Supervision',
      widget: OasisFormBuilder(formId: 41, subFormId: 38),
    ),
  ];
