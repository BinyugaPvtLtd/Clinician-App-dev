...
class OxygenSafetyAssessmentHome extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const OxygenSafetyAssessmentHome({super.key, this.form, this.subForm, this.patient});

  @override
  State<OxygenSafetyAssessmentHome> createState() => _OxygenSafetyAssessmentHomeState();
}

class _OxygenSafetyAssessmentHomeState extends State<OxygenSafetyAssessmentHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      itemTitle: 'Oxygen Safety Assessment',
      widget: OasisFormBuilder(formId: 64, subFormId: 58),
    ),
  ];
