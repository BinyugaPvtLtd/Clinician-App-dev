...
import 'package:clinician_app/pages/oasis_form_builder/constants/constant_import.dart';import 'package:clinician_app/pages/oasis_form_builder/forms/oasis_rn_start_of_care/static_screens/wound_screen.dart';
...
class OasisOTDischarge extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const OasisOTDischarge({super.key, this.form, this.subForm, this.patient});

  @override
  State<OasisOTDischarge> createState() => _OasisOTDischargeState();
}

class _OasisOTDischargeState extends State<OasisOTDischarge> {
  int initialDrawerIndex =20;
  bool isLoading = true;
  ...
  List<SideDrawerItem> sideDrawerItems = [
    // SideDrawerItem(
    //   itemTitle: 'Consent for Care',
    //   widget: OasisFormBuilder(formId: 57, subFormId: 1),
    // ),
    SideDrawerItem(
      itemTitle: 'Clinical Record Items & Patient Signature',
      widget: OasisFormBuilder(formId: 57, subFormId: 3),
    ),
    SideDrawerItem(
      itemTitle: 'Administrative Information',
      widget: OasisFormBuilder(formId: 57, subFormId: 2),
    ),
    SideDrawerItem(
      itemTitle: 'Discharge Data',
      widget: OasisFormBuilder(formId: 57, subFormId: 35),
    ),

    SideDrawerItem(
      itemTitle: 'Patient History/Immunization',
      widget: OasisFormBuilder(formId: 57, subFormId: 4),
    ),
    SideDrawerItem(
      itemTitle: 'Subjective',
      widget: OasisFormBuilder(formId: 57, subFormId: 41),
    ),
    // SideDrawerItem(
    //   itemTitle: 'Living Arrangements',
    //   widget: OasisFormBuilder(formId: 57, subFormId: 5),
    // ),
    // SideDrawerItem(
    //   itemTitle: 'Assistance',
    //   widget: OasisFormBuilder(formId: 57, subFormId: 6),
    // ),
    // SideDrawerItem(
    //   itemTitle: 'Safety Hazards/Emergency Plan',
    //   widget: OasisFormBuilder(formId: 57, subFormId: 7),
    // ),

    SideDrawerItem(
      itemTitle: 'Pain',
      widget: OasisFormBuilder(formId: 57, subFormId: 9),
    ),
    SideDrawerItem(
      itemTitle: 'Vital Signs',
      widget: OasisFormBuilder(formId: 57, subFormId: 8),
    ),
    // SideDrawerItem(
    //   itemTitle: 'Hearing/Speech/Vision',
    //   widget: OasisFormBuilder(formId: 57, subFormId: 10),
    // ),
    SideDrawerItem(
      itemTitle: 'BIMS',
      widget: OasisFormBuilder(formId: 57, subFormId: 11),
    ),
    SideDrawerItem(
      itemTitle: 'Neurological/Cognitive Patterns',
      widget: OasisFormBuilder(formId: 57, subFormId: 12),
    ),
    SideDrawerItem(
      itemTitle: 'Mood',
      widget: OasisFormBuilder(formId: 57, subFormId: 13),
    ),
    SideDrawerItem(
      itemTitle: 'Behavior / Risk Factors',
      widget: OasisFormBuilder(formId: 57, subFormId: 14),
    ),
    SideDrawerItem(
      itemTitle: 'Respiratory/GU/GI/Nutrition',
      widget: OasisFormBuilder(formId: 57, subFormId: 15),
    ),
    // SideDrawerItem(
    //   itemTitle: 'Cardiovascular',
    //   widget: OasisFormBuilder(formId: 57, subFormId: 16),
    // ),
    // SideDrawerItem(
    //   itemTitle: 'Genitourinary',
    //   widget: OasisFormBuilder(formId: 57, subFormId: 17),
    // ),
    // SideDrawerItem(
    //   itemTitle: 'Gastrointestinal/Nutrition/Endocrine',
    //   widget: OasisFormBuilder(formId: 57, subFormId: 18),
    // ),
    SideDrawerItem(
      itemTitle: 'Integumentary/Wound Care',
      widget: OasisFormBuilder(formId: 57, subFormId: 19),
    ),
    SideDrawerItem(
      itemTitle: 'Ulcers/Surgical Wounds',
      widget: OasisFormBuilder(formId: 57, subFormId: 20),
    ),
    // SideDrawerItem(
    //   itemTitle: 'Prior Level Of Function',
    //   widget: OasisFormBuilder(formId: 57, subFormId: 44),
    // ),
    SideDrawerItem(
      itemTitle: 'Musculoskeletal',
      widget: OasisFormBuilder(formId: 57, subFormId: 21),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Assessment',
      widget: OasisFormBuilder(formId: 57, subFormId: 42),
    ),
    SideDrawerItem(
      itemTitle: 'Tests/Scales',
      widget: OasisFormBuilder(formId: 57, subFormId: 43),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Status',
      widget: OasisFormBuilder(formId: 57, subFormId: 22),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Abilities and Goals',
      widget: OasisFormBuilder(formId: 57, subFormId: 23),
    ),
    SideDrawerItem(
      itemTitle: 'Fall Risk/ Therapy Need',
      widget: OasisFormBuilder(formId: 57, subFormId: 24),
    ),
    SideDrawerItem(
      itemTitle: 'Medications',
      widget: OasisFormBuilder(formId: 57, subFormId: 25),
    ),
    // SideDrawerItem(
    //   itemTitle: 'Infusion/Lab Draw',
    //   widget: OasisFormBuilder(formId: 57, subFormId: 26),
    // ),
    SideDrawerItem(
      itemTitle: 'Special Treatment, Procedures, And Programs',
      widget: OasisFormBuilder(formId: 57, subFormId: 27),
    ),
    SideDrawerItem(
      itemTitle: 'Emergent Care',
      widget: OasisFormBuilder(formId: 57, subFormId: 37),
    ),
    SideDrawerItem(
      itemTitle: 'Objective',
      widget: OasisFormBuilder(formId: 57, subFormId: 45),
    ),
    // SideDrawerItem(
    //   itemTitle: 'Interventions/Education Provided',
    //   widget: OasisFormBuilder(formId: 57, subFormId: 29),
    // ),
    SideDrawerItem(
      itemTitle: 'Assessment Summary',
      widget: OasisFormBuilder(formId: 57, subFormId: 30),
    ),
    SideDrawerItem(
      itemTitle: 'Supervision',
      widget: OasisFormBuilder(formId: 57, subFormId: 38),
    ),
    SideDrawerItem(
      itemTitle: 'Discharge Summary',
      widget: OasisFormBuilder(formId: 57, subFormId: 39),
    ),
    SideDrawerItem(
      itemTitle: 'Summary Sent To',
      widget: OasisFormBuilder(formId: 57, subFormId: 40),
    ),
