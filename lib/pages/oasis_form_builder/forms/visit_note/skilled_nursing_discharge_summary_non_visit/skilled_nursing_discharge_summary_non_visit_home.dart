...
class SkilledNursingDischargeSummaryNonVisitHome extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const SkilledNursingDischargeSummaryNonVisitHome({super.key, this.form, this.subForm, this.patient});

  @override
  State<SkilledNursingDischargeSummaryNonVisitHome> createState() => _SkilledNursingDischargeSummaryNonVisitHomeState();
}

class _SkilledNursingDischargeSummaryNonVisitHomeState extends State<SkilledNursingDischargeSummaryNonVisitHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 18, subFormId: 38),
    ),
    SideDrawerItem(
      itemTitle: 'Discharge Summary',
      widget: OasisFormBuilder(formId: 18, subFormId: 39),
    ),
    SideDrawerItem(
      itemTitle: 'Summary Sent To',
      widget: OasisFormBuilder(formId: 18, subFormId: 40),
    ),
  ];
