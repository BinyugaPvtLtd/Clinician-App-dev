...
class MedicalSocialServicesDischargeSummaryNonVisitHome extends StatefulWidget {
  const MedicalSocialServicesDischargeSummaryNonVisitHome({super.key});

  @override
  State<MedicalSocialServicesDischargeSummaryNonVisitHome> createState() =>
      _MedicalSocialServicesDischargeSummaryNonVisitHomeState();
}

class _MedicalSocialServicesDischargeSummaryNonVisitHomeState extends State<MedicalSocialServicesDischargeSummaryNonVisitHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId:22, subFormId: 39),
    ),
    SideDrawerItem(
      itemTitle: 'Summary Sent To',
      widget: OasisFormBuilder(formId:22, subFormId: 40),
    ),
  ];
}
