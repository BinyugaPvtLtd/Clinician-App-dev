...
class SpeechTherapyDischargeSummaryNonVisitHome extends StatefulWidget {
  const SpeechTherapyDischargeSummaryNonVisitHome({super.key});

  @override
  State<SpeechTherapyDischargeSummaryNonVisitHome> createState() =>
      _SpeechTherapyDischargeSummaryNonVisitHomeState();
}

class _SpeechTherapyDischargeSummaryNonVisitHomeState extends State<SpeechTherapyDischargeSummaryNonVisitHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId:21, subFormId: 38),
    ),
    SideDrawerItem(
      itemTitle: 'DischargeSummary',
      widget: OasisFormBuilder(formId:21, subFormId: 39),
    ),
    SideDrawerItem(
      itemTitle: 'Summary Sent To',
      widget: OasisFormBuilder(formId:21, subFormId: 40),
    ),
  ];
}
