...
class PhysicalTherapyDischargeSummaryNonVisitHome extends StatefulWidget {
  const PhysicalTherapyDischargeSummaryNonVisitHome({super.key});

  @override
  State<PhysicalTherapyDischargeSummaryNonVisitHome> createState() => _PhysicalTherapyDischargeSummaryNonVisitHomeState();
}

class _PhysicalTherapyDischargeSummaryNonVisitHomeState extends State<PhysicalTherapyDischargeSummaryNonVisitHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 19, subFormId: 38),
    ),
    SideDrawerItem(
      itemTitle: 'Discharge Summary',
      widget: OasisFormBuilder(formId: 19, subFormId: 39),
    ),
    SideDrawerItem(
      itemTitle: 'Summary Sent To',
      widget: OasisFormBuilder(formId: 19, subFormId: 40),
    ),
  ];
}
