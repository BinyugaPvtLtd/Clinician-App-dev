...
class Question340600002 extends StatelessWidget{
  final QuestionWrapper questionWrapper;

  Question340600002({super.key, required this.questionWrapper,  });

   double maxWidthForMobile = 750;
  ...
  Widget _getHeadingRow(isMobile) {
    return Container(
      constraints:
      isMobile ? BoxConstraints(maxWidth: maxWidthForMobile) : null,
      child: Row(
