...
class HomeHealthAideVisitNote extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const HomeHealthAideVisitNote({super.key, this.form, this.subForm, this.patient});

  @override
  State<HomeHealthAideVisitNote> createState() => _HomeHealthAideVisitNoteState();
}

class _HomeHealthAideVisitNoteState extends State<HomeHealthAideVisitNote> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 34, subFormId: 46),
    ),
    SideDrawerItem(
      itemTitle: 'Report to Supervising Clinician',
      widget: OasisFormBuilder(formId: 34, subFormId: 48),
    ),
    SideDrawerItem(
      itemTitle: 'Safety Precautions',
      widget: OasisFormBuilder(formId: 34, subFormId: 49),
    ),
    SideDrawerItem(
      itemTitle: 'Tasks',
      widget: OasisFormBuilder(formId: 34, subFormId: 50),
    ),
  ];
