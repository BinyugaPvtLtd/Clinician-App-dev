...
class PhysicalTherapyMissedVisitNoteHome extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const PhysicalTherapyMissedVisitNoteHome({super.key, this.form, this.subForm, this.patient});

  @override
  State<PhysicalTherapyMissedVisitNoteHome> createState() => _PhysicalTherapyMissedVisitNoteHomeState();
}

class _PhysicalTherapyMissedVisitNoteHomeState extends State<PhysicalTherapyMissedVisitNoteHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 25, subFormId: 46),
    ),
    SideDrawerItem(
      itemTitle: 'Missed Visit Information',
      widget: OasisFormBuilder(formId: 25, subFormId: 47),
    ),
  ];
