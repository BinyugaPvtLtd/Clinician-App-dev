...
class SpeechTherapyMissedVisitNoteHome extends StatefulWidget {
  const SpeechTherapyMissedVisitNoteHome({super.key});

  @override
  State<SpeechTherapyMissedVisitNoteHome> createState() => _SpeechTherapyMissedVisitNoteHomeState();
}

class _SpeechTherapyMissedVisitNoteHomeState extends State<SpeechTherapyMissedVisitNoteHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 27, subFormId: 46),
    ),
    SideDrawerItem(
      itemTitle: 'Missed Visit Information',
      widget: OasisFormBuilder(formId: 27, subFormId: 47),
    ),
  ];
}
