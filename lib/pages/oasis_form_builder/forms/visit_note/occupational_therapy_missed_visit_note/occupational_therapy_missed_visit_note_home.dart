...
class OccupationalTherapyMissedVisitNoteHome extends StatefulWidget {
  const OccupationalTherapyMissedVisitNoteHome({super.key});

  @override
  State<OccupationalTherapyMissedVisitNoteHome> createState() => _OccupationalTherapyMissedVisitNoteHomeState();
}

class _OccupationalTherapyMissedVisitNoteHomeState extends State<OccupationalTherapyMissedVisitNoteHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 26, subFormId: 46),
    ),
    SideDrawerItem(
      itemTitle: 'Missed Visit Information',
      widget: OasisFormBuilder(formId: 26, subFormId: 47),
    ),
  ];
}
