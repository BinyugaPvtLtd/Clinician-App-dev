...
class HomeHealthAideMissedVisitNoteHome extends StatefulWidget {
  const HomeHealthAideMissedVisitNoteHome({super.key});

  @override
  State<HomeHealthAideMissedVisitNoteHome> createState() => _HomeHealthAideMissedVisitNoteHomeState();
}

class _HomeHealthAideMissedVisitNoteHomeState extends State<HomeHealthAideMissedVisitNoteHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 29, subFormId: 46),
    ),
    SideDrawerItem(
      itemTitle: 'Missed Visit Information',
      widget: OasisFormBuilder(formId: 29, subFormId: 47),
    ),
  ];
}
