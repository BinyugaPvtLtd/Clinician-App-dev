...
class SkilledNursingPatientMissedVisitHome extends StatefulWidget {
  const SkilledNursingPatientMissedVisitHome({super.key});

  @override
  State<SkilledNursingPatientMissedVisitHome> createState() => _SkilledNursingPatientMissedVisitHomeState();
}

class _SkilledNursingPatientMissedVisitHomeState extends State<SkilledNursingPatientMissedVisitHome> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 24, subFormId: 46),
    ),
    SideDrawerItem(
      itemTitle: 'Missed Visit Information',
      widget: OasisFormBuilder(formId: 24, subFormId: 47),
    ),
  ];
}
