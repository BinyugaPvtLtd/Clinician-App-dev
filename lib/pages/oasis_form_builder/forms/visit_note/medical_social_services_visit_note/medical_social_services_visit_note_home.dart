...
class MedicalSocialServicesVisitNote extends StatefulWidget {
  const MedicalSocialServicesVisitNote({super.key});

  @override
  State<MedicalSocialServicesVisitNote> createState() => _MedicalSocialServicesVisitNoteState();
}

class _MedicalSocialServicesVisitNoteState extends State<MedicalSocialServicesVisitNote> {
  bool isLoading = true;
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 65, subFormId: 4),
    ),
    SideDrawerItem(
      itemTitle: 'Clinical Record Items',
      widget: OasisFormBuilder(formId: 65, subFormId: 3),
    ),
    SideDrawerItem(
      itemTitle: 'Interventions/Education Provided',
      widget: OasisFormBuilder(formId: 65, subFormId: 29),
    ),
    SideDrawerItem(
      itemTitle: 'Assessment',
      widget: OasisFormBuilder(formId: 65, subFormId: 30),
    ),
    SideDrawerItem(
      itemTitle: 'Care Planning/Coordination',
      widget: OasisFormBuilder(formId: 65, subFormId: 33),
    ),
  ];
}
