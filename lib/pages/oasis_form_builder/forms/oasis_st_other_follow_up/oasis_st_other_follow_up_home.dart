...
class OasisSTOtherFollowUp extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const OasisSTOtherFollowUp({super.key, this.form, this.subForm, this.patient});

  @override
  State<OasisSTOtherFollowUp> createState() => _OasisSTOtherFollowUpState();
}

class _OasisSTOtherFollowUpState extends State<OasisSTOtherFollowUp> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 54, subFormId: 36),
    ),
    SideDrawerItem(
      itemTitle: 'Administrative Information',
      widget: OasisFormBuilder(formId: 54, subFormId: 2),
    ),
    SideDrawerItem(
      itemTitle: 'Subjective',
      widget: OasisFormBuilder(formId: 54, subFormId: 41),
    ),
    SideDrawerItem(
      itemTitle: 'Pain',
      widget: OasisFormBuilder(formId: 54, subFormId: 9),
    ),
    SideDrawerItem(
      itemTitle: 'Vital Signs',
      widget: OasisFormBuilder(formId: 54, subFormId: 8),
    ),
    SideDrawerItem(
      itemTitle: 'Immunizations/Care Management',
      widget: OasisFormBuilder(formId: 54, subFormId: 4),
    ),
    SideDrawerItem(
      itemTitle: 'Safety Hazards/Emergency Plan',
      widget: OasisFormBuilder(formId: 54, subFormId: 7),
    ),
    // SideDrawerItem(
    //   itemTitle: 'Assistance',
    //   widget: OasisFormBuilder(formId: 54, subFormId: 6),
    // ),
    SideDrawerItem(
      itemTitle: 'Neurological/Cognitive Patterns',
      widget: OasisFormBuilder(formId: 54, subFormId: 12),
    ),
    SideDrawerItem(
      itemTitle: 'Behavior / Risk Factors',
      widget: OasisFormBuilder(formId: 54, subFormId: 14),
    ),
    SideDrawerItem(
      itemTitle: 'Respiratory/Cardiovascular',
      widget: OasisFormBuilder(formId: 54, subFormId: 15),
    ),
    // SideDrawerItem(
    //   itemTitle: 'Cardiovascular',
    //   widget: OasisFormBuilder(formId: 54, subFormId: 16),
    // ),
    SideDrawerItem(
      itemTitle: 'GU/GI/Nutrition/Endocrine',
      widget: OasisFormBuilder(formId: 54, subFormId: 17),
    ),
    // SideDrawerItem(
    //   itemTitle: 'Gastrointestinal/Nutrition/Endocrine',
    //   widget: OasisFormBuilder(formId: 54, subFormId: 18),
    // ),
    SideDrawerItem(
      itemTitle: 'Integumentary',
      widget: OasisFormBuilder(formId: 54, subFormId: 19),
    ),
    SideDrawerItem(
      itemTitle: 'Musculoskeletal',
      widget: OasisFormBuilder(formId: 54, subFormId: 21),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Assessment',
      widget: StaticFunctionalAssessment(formId: 54, subFormId: 42),
    ),
    SideDrawerItem(
      itemTitle: 'Tests/Scales',
      widget: OasisFormBuilder(formId: 54, subFormId: 43),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Status',
      widget: OasisFormBuilder(formId: 54, subFormId: 22),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Abilities and Goals',
      widget: OasisFormBuilder(formId: 54, subFormId: 23),
    ),
    SideDrawerItem(
      itemTitle: 'Fall Risk Assessment',
      widget: OasisFormBuilder(formId: 54, subFormId: 24),
    ),
    SideDrawerItem(
      itemTitle: 'Medications',
      widget: OasisFormBuilder(formId: 54, subFormId: 25),
    ),
    // SideDrawerItem(
    //   itemTitle: 'Infusion/Lab Draw',
    //   widget: OasisFormBuilder(formId: 54, subFormId: 26),
    // ),
    SideDrawerItem(
      itemTitle: 'Rehospitalization Risk',
      widget: OasisFormBuilder(formId: 54, subFormId: 28),
    ),
    SideDrawerItem(
      itemTitle: 'Objective',
      widget: OasisFormBuilder(formId: 54, subFormId: 45),
    ),
    SideDrawerItem(
      itemTitle: 'Assessment',
      widget: OasisFormBuilder(formId: 54, subFormId: 30),
    ),
    // SideDrawerItem(
    //   itemTitle: 'Supplies',
    //   widget: OasisFormBuilder(formId: 54, subFormId: 31),
    // ),
    SideDrawerItem(
      itemTitle: 'Plan Of Care',
      widget: OasisFormBuilder(formId: 54, subFormId: 32),
    ),
    SideDrawerItem(
      itemTitle: 'Care Planning/Coordination',
      widget: OasisFormBuilder(formId: 54, subFormId: 33),
    ),
    SideDrawerItem(
      itemTitle: 'Supervision',
      widget: OasisFormBuilder(formId: 54, subFormId: 38),
    ),
    SideDrawerItem(
      itemTitle: 'Diagnosis Codes',
      widget: OasisFormBuilder(formId: 54, subFormId: 34),
    ),
  ];
