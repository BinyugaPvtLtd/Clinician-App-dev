...
class FormDataSTOtherFollowUp {
  static Map<int, Map<String,dynamic>> stFollowUpDrawerItems = {
  ...
  static Map<String,dynamic> clinicalRecordItemsPatientSignature = {
    "template_name": "OASIS ST Other Follow Up",
...
ulcers/injuries)''',
 ...
 <br><br><b>88. Not attempted due to medical conditions or safety concerns</b>''',
      ...
      ...List.generate(3, (index) {
        ...
        return {
          'question_type_id': 540974001 + (index + 1),
          "type": "STATIC",
          "question_type": "COMPREHENSIVE",
          "title": titleList[index],
          "dynamic_type": false,
 ...
 <br><br><b>88. Not attempted due to medical conditions or safety concerns</b>''',
      ...
      ...List.generate(11, (index) {
        ...
        return {
          'question_type_id': 540974005 + (index + 1),
          "type": "STATIC",
          "question_type": "COMPREHENSIVE",
          "title": titleList[index],
        ...
        "questions": [
          {
            ...
            "options": [
              ...
              {"index": 0, "value": "HHA", "label": "HHA", "selected": false}
            ]
          },
          {
            'question_id': 2,
