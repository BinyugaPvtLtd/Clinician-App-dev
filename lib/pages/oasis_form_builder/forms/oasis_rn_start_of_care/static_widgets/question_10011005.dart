...
class Question10011005 extends StatelessWidget {
  const Question10011005({super.key, required this.queWrapper});
    ...
    return ChangeNotifierProvider<QuestionWrapper>.value(
      ...
      child: Consumer<QuestionWrapper>(builder: (context, que, ch) {
        ...
        return isMobile?Column(
          children: [
            StaticOptionWidget(subQuestionWrapper: subQuestionWrappers[0]),
            _getAdditionalDetailsWidget(context, subQuestionWrappers[1]),

            customHeight(28.h),

            StaticOptionWidget(subQuestionWrapper: subQuestionWrappers[2]),
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Expanded(child: _getAdditionalDetailsWidget(context, subQuestionWrappers[1]))
              ],
            ),
            customHeight(28.h),
            // b.
            Row(
              ...
              children: [
                ...
                customWidth(isTablet ? 50 : 100),
                Expanded(child: _getAdditionalDetailsWidget(context, subQuestionWrappers[3])),
              ],
            ),
            customHeight(28.h),
            // c.
