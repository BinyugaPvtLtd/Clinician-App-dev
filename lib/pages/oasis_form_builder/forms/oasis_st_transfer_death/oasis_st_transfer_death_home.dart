...
import '../../side_drawer/side_drawer_item.dart';
...
class OasisSTTransferDeath extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const OasisSTTransferDeath({super.key, this.form, this.subForm, this.patient});

  @override
  State<OasisSTTransferDeath> createState() => _OasisSTTransferDeathState();
}

class _OasisSTTransferDeathState extends State<OasisSTTransferDeath> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 5, subFormId: 2),
    ),
    SideDrawerItem(
      itemTitle: 'Patient History/Immunization',
      widget: OasisFormBuilder(formId: 5, subFormId: 4),
    ),
    SideDrawerItem(
      itemTitle: 'Medications',
      widget: OasisFormBuilder(formId: 5, subFormId: 25),
    ),
    SideDrawerItem(
      itemTitle: 'Transfer/Discharge Data Items',
      widget: OasisFormBuilder(formId: 5, subFormId: 35),
    ),
    SideDrawerItem(
      itemTitle: 'Discharge Summary',
      widget: OasisFormBuilder(formId: 5, subFormId: 39),
    ),
    SideDrawerItem(
      itemTitle: 'Summary Sent To',
      widget: OasisFormBuilder(formId: 5, subFormId: 40),
    ),
  ];
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: AppColors.primaryLightBackGColor,
