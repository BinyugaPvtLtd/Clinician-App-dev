...
class OasisPTRecert extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const OasisPTRecert({super.key, this.form, this.subForm, this.patient});

  @override
  State<OasisPTRecert> createState() => _OasisPTRecertState();
}

class _OasisPTRecertState extends State<OasisPTRecert> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 48, subFormId: 3),
    ),
    SideDrawerItem(
      itemTitle: 'Administrative Information',
      widget: OasisFormBuilder(formId: 48, subFormId: 2),
    ),

    SideDrawerItem(
      itemTitle: 'Subjective',
      widget: OasisFormBuilder(formId: 48, subFormId: 41),
    ),
    SideDrawerItem(
      itemTitle: 'Pain',
      widget: OasisFormBuilder(formId: 48, subFormId: 9),
    ),
    SideDrawerItem(
      itemTitle: 'Vital Signs/Pain/Height & Weight',
      widget: OasisFormBuilder(formId: 48, subFormId: 8),
    ),
    SideDrawerItem(
      itemTitle: 'Immunization/Care Management',
      widget: OasisFormBuilder(formId: 48, subFormId: 4),
    ),
    SideDrawerItem(
      itemTitle: 'Safety Hazards/Emergency Plan',
      widget: OasisFormBuilder(formId: 48, subFormId: 7),
    ),
    SideDrawerItem(
      itemTitle: 'Neurological/Cognitive Status',
      widget: OasisFormBuilder(formId: 48, subFormId: 12),
    ),
    SideDrawerItem(
      itemTitle: 'Behavior / Risk Factors',
      widget: OasisFormBuilder(formId: 48, subFormId: 14),
    ),
    SideDrawerItem(
      itemTitle: 'Respiratory',
      widget: OasisFormBuilder(formId: 48, subFormId: 15),
    ),

    SideDrawerItem(
      itemTitle: 'GU/GI/Nutrition/Endocrine',
      widget: OasisFormBuilder(formId: 48, subFormId: 18),
    ),

    SideDrawerItem(
      itemTitle: 'Integumentary/Wound Care',
      widget: OasisFormBuilder(formId: 48, subFormId: 19),
    ),
    SideDrawerItem(
      itemTitle: 'Musculoskeletal',
      widget: OasisFormBuilder(formId: 48, subFormId: 21),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Assessment',
      widget: OasisFormBuilder(formId: 48, subFormId: 42),
    ),
    SideDrawerItem(
      itemTitle: 'Tests/Scales',
      widget: OasisFormBuilder(formId: 48, subFormId: 43),
    ),

    SideDrawerItem(
      itemTitle: 'Functional Status',
      widget: OasisFormBuilder(formId: 48, subFormId: 22),
    ),

    SideDrawerItem(
      itemTitle: 'Functional Abilities and Goals',
      widget: OasisFormBuilder(formId: 48, subFormId: 23),
    ),
    SideDrawerItem(
      itemTitle: 'Fall Risk Assessment',
      widget: OasisFormBuilder(formId: 48, subFormId: 24),
    ),

    SideDrawerItem(
      itemTitle: 'Medications',
      widget: OasisFormBuilder(formId: 48, subFormId: 25),
    ),
    SideDrawerItem(
      itemTitle: 'Rehospitalization Risk',
      widget: OasisFormBuilder(formId: 48, subFormId: 28),
    ),
    SideDrawerItem(
      itemTitle: 'Objective',
      widget: OasisFormBuilder(formId: 48, subFormId: 45),
    ),
    SideDrawerItem(
      itemTitle: 'Assessment',
      widget: OasisFormBuilder(formId: 48, subFormId: 30),
    ),SideDrawerItem(
      itemTitle: 'Supervision',
      widget: OasisFormBuilder(formId: 48, subFormId: 38),
    ),
    SideDrawerItem(
      itemTitle: 'Plan Of Care',
      widget: OasisFormBuilder(formId: 48, subFormId: 32),
    ),
    SideDrawerItem(
      itemTitle: 'Plan/Care Coordination',
      widget: OasisFormBuilder(formId: 48, subFormId: 33),
    ),
    SideDrawerItem(
      itemTitle: 'Diagnosis Codes',
      widget: OasisFormBuilder(formId: 48, subFormId: 34),
    ),
  ];
