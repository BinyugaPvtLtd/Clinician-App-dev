...
class OasisOTDischargeNonVisitHome extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const OasisOTDischargeNonVisitHome({super.key, this.form, this.subForm, this.patient});

  @override
  State<OasisOTDischargeNonVisitHome> createState() => _OasisOTDischargeNonVisitHomeState();
}

class _OasisOTDischargeNonVisitHomeState extends State<OasisOTDischargeNonVisitHome> {
  int initialDrawerIndex =10;
  bool isLoading = true;
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 16, subFormId: 2),
    ),
    SideDrawerItem(
      itemTitle: 'Discharge Data',
      widget: OasisFormBuilder(formId: 16, subFormId: 35),
    ),
    SideDrawerItem(
      itemTitle: 'Patient History/Immunization',
      widget: OasisFormBuilder(formId: 16, subFormId: 4),
    ),
    SideDrawerItem(
      itemTitle: 'Pain',
      widget: OasisFormBuilder(formId: 16, subFormId: 9),
    ),
    SideDrawerItem(
      itemTitle: 'BIMS',
      widget: OasisFormBuilder(formId: 16, subFormId: 11),
    ),
    SideDrawerItem(
      itemTitle: 'Neurological/Cognitive',
      widget: OasisFormBuilder(formId: 16, subFormId: 12),
    ),
    SideDrawerItem(
      itemTitle: 'Mood',
      widget: OasisFormBuilder(formId: 16, subFormId: 13),
    ),
    SideDrawerItem(
      itemTitle: 'Behavior',
      widget: OasisFormBuilder(formId: 16, subFormId: 14),
    ),
    SideDrawerItem(
      itemTitle: 'Respiratory / GU / GI / Nutrition',
      widget: OasisFormBuilder(formId: 16, subFormId: 15),
    ),
    SideDrawerItem(
      itemTitle: 'Ulcers/Surgical Wounds',
      widget: OasisFormBuilder(formId: 16, subFormId: 20),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Status',
      widget: OasisFormBuilder(formId: 16, subFormId: 22),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Abilities and Goals',
      widget: OasisFormBuilder(formId: 16, subFormId: 23),
    ),
    SideDrawerItem(
      itemTitle: 'Assistance / Falls',
      widget: OasisFormBuilder(formId: 16, subFormId: 24),
    ),
    SideDrawerItem(
      itemTitle: 'Medications',
      widget: OasisFormBuilder(formId: 16, subFormId: 25),
    ),
    SideDrawerItem(
      itemTitle: 'Special Treatment, Procedures, And Programs',
      widget: OasisFormBuilder(formId: 16, subFormId: 27),
    ),
    SideDrawerItem(
      itemTitle: 'Emergent Care',
      widget: OasisFormBuilder(formId: 16, subFormId: 37),
    ),
    SideDrawerItem(
      itemTitle: 'Interventions/Education Provided',
      widget: OasisFormBuilder(formId: 16, subFormId: 29),
    ),
    SideDrawerItem(
      itemTitle: 'Supervision',
      widget: OasisFormBuilder(formId: 16, subFormId: 38),
    ),
    SideDrawerItem(
      itemTitle: 'Discharge Summary',
      widget: OasisFormBuilder(formId: 16, subFormId: 39),
    ),
    SideDrawerItem(
      itemTitle: 'Summary Sent To',
      widget: OasisFormBuilder(formId: 16, subFormId: 40),
    ),
  ];
