...
class OasisPTRocRecert extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const OasisPTRocRecert({super.key, this.form, this.subForm, this.patient});

  @override
  State<OasisPTRocRecert> createState() => _OasisPTRocRecertState();
}

class _OasisPTRocRecertState extends State<OasisPTRocRecert> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 11, subFormId: 2),
    ),
    SideDrawerItem(
      itemTitle: 'Clinical Record Items',
      widget: OasisFormBuilder(formId: 11, subFormId: 3),
    ),
    SideDrawerItem(
      itemTitle: 'Patient History/Immunization',
      widget: OasisFormBuilder(formId: 11, subFormId: 4),
    ),
    SideDrawerItem(
      itemTitle: 'Living Arrangements',
      widget: OasisFormBuilder(formId: 11, subFormId: 5),
    ),
    SideDrawerItem(
      itemTitle: 'Assistance',
      widget: OasisFormBuilder(formId: 11, subFormId: 6),
    ),
    SideDrawerItem(
      itemTitle: 'Safety Hazards/Emergency Plan',
      widget: OasisFormBuilder(formId: 11, subFormId: 7),
    ),
    SideDrawerItem(
      itemTitle: 'Subjective',
      widget: OasisFormBuilder(formId: 11, subFormId: 41),
    ),
    SideDrawerItem(
      itemTitle: 'Vital Signs/Pain/Height & Weight',
      widget: OasisFormBuilder(formId: 11, subFormId: 8),
    ),
    SideDrawerItem(
      itemTitle: 'Pain',
      widget: OasisFormBuilder(formId: 11, subFormId: 9),
    ),
    SideDrawerItem(
      itemTitle: 'Hearing/Speech/Vision',
      widget: OasisFormBuilder(formId: 11, subFormId: 10),
    ),
    SideDrawerItem(
      itemTitle: 'BIMS',
      widget: OasisFormBuilder(formId: 11, subFormId: 11),
    ),
    SideDrawerItem(
      itemTitle: 'Neurological/Cognitive Patterns',
      widget: OasisFormBuilder(formId: 11, subFormId: 12),
    ),
    SideDrawerItem(
      itemTitle: 'Mood',
      widget: OasisFormBuilder(formId: 11, subFormId: 13),
    ),
    SideDrawerItem(
      itemTitle: 'Behavior / Risk Factors',
      widget: OasisFormBuilder(formId: 11, subFormId: 14),
    ),
    SideDrawerItem(
      itemTitle: 'Respiratory',
      widget: OasisFormBuilder(formId: 11, subFormId: 15),
    ),
    SideDrawerItem(
      itemTitle: 'Cardiovascular',
      widget: OasisFormBuilder(formId: 11, subFormId: 16),
    ),
    SideDrawerItem(
      itemTitle: 'Genitourinary',
      widget: OasisFormBuilder(formId: 11, subFormId: 17),
    ),
    SideDrawerItem(
      itemTitle: 'Gastrointestinal/Nutrition/Endocrine',
      widget: OasisFormBuilder(formId: 11, subFormId: 18),
    ),
    SideDrawerItem(
      itemTitle: 'Integumentary/Wound Care',
      widget: OasisFormBuilder(formId: 11, subFormId: 19),
    ),
    SideDrawerItem(
      itemTitle: 'Ulcers/Surgical Wounds',
      widget: OasisFormBuilder(formId: 11, subFormId: 20),
    ),
    SideDrawerItem(
      itemTitle: 'Prior Level Of Function',
      widget: OasisFormBuilder(formId: 11, subFormId: 44),
    ),
    SideDrawerItem(
      itemTitle: 'Musculoskeletal',
      widget: OasisFormBuilder(formId: 11, subFormId: 21),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Assessment',
      widget: OasisFormBuilder(formId: 11, subFormId: 42),
    ),
    SideDrawerItem(
      itemTitle: 'Tests/Scales',
      widget: OasisFormBuilder(formId: 11, subFormId: 43),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Status',
      widget: OasisFormBuilder(formId: 11, subFormId: 22),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Abilities and Goals',
      widget: OasisFormBuilder(formId: 11, subFormId: 23),
    ),
    SideDrawerItem(
      itemTitle: 'Fall Risk/ Therapy Need',
      widget: OasisFormBuilder(formId: 11, subFormId: 24),
    ),
    SideDrawerItem(
      itemTitle: 'Medications',
      widget: OasisFormBuilder(formId: 11, subFormId: 25),
    ),
    SideDrawerItem(
      itemTitle: 'Special Treatment, Procedures, And Programs',
      widget: OasisFormBuilder(formId: 11, subFormId: 27),
    ),
    SideDrawerItem(
      itemTitle: 'Rehospitalization Risk',
      widget: OasisFormBuilder(formId: 11, subFormId: 28),
    ),
    SideDrawerItem(
      itemTitle: 'Objective',
      widget: OasisFormBuilder(formId: 11, subFormId: 45),
    ),
    SideDrawerItem(
      itemTitle: 'Assessment',
      widget: OasisFormBuilder(formId: 11, subFormId: 30),
    ),
    SideDrawerItem(
      itemTitle: 'Plan Of Care',
      widget: OasisFormBuilder(formId: 11, subFormId: 32),
    ),
    SideDrawerItem(
      itemTitle: 'Plan/Care Coordination',
      widget: OasisFormBuilder(formId: 11, subFormId: 33),
    ),
    SideDrawerItem(
      itemTitle: 'Diagnosis Codes',
      widget: OasisFormBuilder(formId: 11, subFormId: 34),
    ),
  ];
