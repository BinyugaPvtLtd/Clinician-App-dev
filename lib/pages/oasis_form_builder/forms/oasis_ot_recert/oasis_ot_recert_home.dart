...
class OasisOTRecert extends StatefulWidget {
  final PatientForm? form;
  final PatientSubForm? subForm;
  final ChartPatientReferral? patient;

  const OasisOTRecert({super.key, this.form, this.subForm, this.patient});

  @override
  State<OasisOTRecert> createState() => _OasisOTRecertState();
}

class _OasisOTRecertState extends State<OasisOTRecert> {
  ...
  List<SideDrawerItem> sideDrawerItems = [
    SideDrawerItem(
      ...
      widget: OasisFormBuilder(formId: 49, subFormId: 3),
    ),
    SideDrawerItem(
      itemTitle: 'Administrative Information',
      widget: OasisFormBuilder(formId: 49, subFormId: 2),
    ),
    SideDrawerItem(
      itemTitle: 'Subjective',
      widget: OasisFormBuilder(formId: 49, subFormId: 41),
    ),
    SideDrawerItem(
      itemTitle: 'Pain',
      widget: OasisFormBuilder(formId: 49, subFormId: 9),
    ),
    SideDrawerItem(
      itemTitle: 'Vital Signs',
      widget: OasisFormBuilder(formId: 49, subFormId: 8),
    ),
    SideDrawerItem(
      itemTitle: 'Immunization/Care Management',
      widget: OasisFormBuilder(formId: 49, subFormId: 4),
    ),
    SideDrawerItem(
      itemTitle: 'Safety Hazards/Emergency Plan',
      widget: OasisFormBuilder(formId: 49, subFormId: 7),
    ),
    SideDrawerItem(
      itemTitle: 'Neurological/Cognitive Patterns',
      widget: OasisFormBuilder(formId: 49, subFormId: 12),
    ),
    SideDrawerItem(
      itemTitle: 'Behavior / Risk Factors',
      widget: OasisFormBuilder(formId: 49, subFormId: 14),
    ),
    SideDrawerItem(
      itemTitle: 'Respiratory/Cardiovascular',
      widget: OasisFormBuilder(formId: 49, subFormId: 15),
    ),
    SideDrawerItem(
      itemTitle: 'GU/GI/Nutrition/Endocrine',
      widget: OasisFormBuilder(formId: 49, subFormId: 18),
    ),
    SideDrawerItem(
      itemTitle: 'Integumentary',
      widget: OasisFormBuilder(formId: 49, subFormId: 19),
    ),
    SideDrawerItem(
      itemTitle: 'Musculoskeletal',
      widget: OasisFormBuilder(formId: 49, subFormId: 21),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Assessment',
      widget: OasisFormBuilder(formId: 49, subFormId: 42),
    ),
    SideDrawerItem(
      itemTitle: 'Tests/Scales',
      widget: OasisFormBuilder(formId: 49, subFormId: 43),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Status',
      widget: OasisFormBuilder(formId: 49, subFormId: 22),
    ),
    SideDrawerItem(
      itemTitle: 'Functional Abilities and Goals',
      widget: OasisFormBuilder(formId: 49, subFormId: 23),
    ),
    SideDrawerItem(
      itemTitle: 'Fall Risk Assessment',
      widget: OasisFormBuilder(formId: 49, subFormId: 24),
    ),
    SideDrawerItem(
      itemTitle: 'Medications',
      widget: OasisFormBuilder(formId: 49, subFormId: 25),
    ),
    SideDrawerItem(
      itemTitle: 'Rehospitalization Risk',
      widget: OasisFormBuilder(formId: 49, subFormId: 28),
    ),
    SideDrawerItem(
      itemTitle: 'Objective',
      widget: OasisFormBuilder(formId: 49, subFormId: 45),
    ),
    SideDrawerItem(
      itemTitle: 'Assessment Summary',
      widget: OasisFormBuilder(formId: 49, subFormId: 30),
    ),
    SideDrawerItem(
      itemTitle: 'Plan Of Care',
      widget: OasisFormBuilder(formId: 49, subFormId: 32),
    ),
    SideDrawerItem(
      itemTitle: 'Care Planning/Coordination',
      widget: OasisFormBuilder(formId: 49, subFormId: 33),
    ),
    SideDrawerItem(
      itemTitle: 'Supervision',
      widget: OasisFormBuilder(formId: 49, subFormId: 38),
    ),
    SideDrawerItem(
      itemTitle: 'Diagnosis Codes',
      widget: OasisFormBuilder(formId: 49, subFormId: 34),
    ),
  ];
