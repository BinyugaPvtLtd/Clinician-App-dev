...
class FormDataPTOtherFollowUp {
  static Map<int, Map<String,dynamic>> ptFollowUpDrawerItems = {
  ...
  static Map<String,dynamic> clinicalRecordItemsPatientSignature = {
    "template_name": "OASIS PT Other Follow Up",
  ...
  static Map<String,dynamic> guGiNutritianEndocrine = {
    ...
    "questions": [
        ...
        "questions": [
          {
            ...
            "scroll_axis": "HORIZONTAL",
            "options": [
              {"index": 0, "value": "", "label": "", "selected": false,"popup_code":"TEXTFIELDPOPUP"}
            ]
          },
          {
            "question_id": 2,
      ...
      {
        'question_type_id': 520917006,
        "type": "BUTTON",
        "question_type": "NON-COMPREHENSIVE",
        "title": "",
        "code": "<u>Nutritional Requirements</u>",
        "description": "",
        "scroll_axis": "HORIZONTAL",
        "options_alignment": "HORIZONTAL",
        "group_options": true,
...
ulcers/injuries)''',
      ...
      },
      {
        ...
        "questions": [
          ...List.generate(
            3,
            (index) {
              var list = ['Light Touch', 'Dull/Sharp', 'Joint Position Sense'];
              return {
                'question_id': index + 1,
                "type": "RADIO",
                // "scroll_axis": "HORIZONTAL",
 ...
 <br><br><b>88. Not attempted due to medical conditions or safety concerns</b>''',
      ...
      ...List.generate(3, (index) {
        ...
        return {
          'question_type_id': 520923001 + (index + 1),
          "type": "STATIC",
          "question_type": "COMPREHENSIVE",
          "title": titleList[index],
          "dynamic_type": false,
 ...
 <br><br><b>88. Not attempted due to medical conditions or safety concerns</b>''',
      ...
      ...List.generate(11, (index) {
        ...
        return {
          'question_type_id': 520923005 + (index + 1),
          "type": "STATIC",
          "question_type": "COMPREHENSIVE",
          "title": titleList[index],
  ...
  static Map<String,dynamic> medications = {
    ...
    'questions': [
      {
        'question_type_id': 520925001,
        "type": "RADIO",
        "question_type": "COMPREHENSIVE",
        "title": "<b> Medication Management</b>",
        "description": "Does patient have all prescribed medications?",
        "dynamic_type": true,
        // "options_alignment": "HORIZONTAL",
        "has_color": true,
        "answer_id": 0,
  ...
  static Map<String,dynamic> objective = {
    ...
    'questions': [
      {
        "question_type_id": 520927001, //571063002,
        "type": "STATIC",
        "dynamic_type": false,
            ...
            return {
              ...
              "options": [
                ...
                if (index == 0)
                  {
                    "index": 1,
                    "label": '<b>Request PTA to follow</b>',
        ...
        "questions": [
          {
            ...
            "answer_id": 0,
            "options": [
              {"index": 0, "value": "PTA", "label": "PTA", "selected": false},
